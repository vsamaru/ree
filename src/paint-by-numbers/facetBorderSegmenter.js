...
var FacetBorderSegmenter = /** @class */ (function () {
    ...
    FacetBorderSegmenter.matchSegmentsWithNeighbours = function (facetResult, segmentsPerFacet, onUpdate) {
        if (onUpdate === void 0) { onUpdate = null; }
        return __awaiter(this, void 0, void 0, function () {
            var MAX_DISTANCE, _i, _a, f, count, _b, _c, f, debug_1, s, segment, neighbourFacet, matchFound, neighbourSegments, ns, neighbourSegment, segStartPoint, segEndPoint, nSegStartPoint, nSegEndPoint, matchesStraight, matchesReverse;
